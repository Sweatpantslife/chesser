  ...
  persist(
    (set, get) => ({
      ...
      grade(deck, id, g) {
        ...
        hist[d] = { reviews: day.reviews + 1, correct: day.correct + (g === 'again' ? 0 : 1) };
        ...
        set({ cards: { ...get().cards, [k]: updated }, history: hist, lastActiveDay: d, streak });
      },
      ...
      reset() {
        set({ cards: {}, history: {}, lastActiveDay: '', streak: 0 });
      },
    }),
    { name: 'chesser-progress', version: 1 },
  ),
);
